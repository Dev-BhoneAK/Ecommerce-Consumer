    ...
    <div>
      <form className="form_search ajax-search the-basics">
        <input
          ...
          className="nav-search nav-search-field typeahead"
        ...
        >
          <div className="tt-dataset tt-dataset-states">
            <a
              ...
              className="man-section tt-suggestion tt-selectable"
            >
              ...
              <div className="description-section">
                <h4>
                  <strong className="tt-highlight">Ap</strong>ple Phones
                </h4>
                <span>$250</span>
              </div>
            </a>
            ...
            >
              ...
              <div className="description-section">
                <h4>
                  C<strong className="tt-highlight">a</strong>r{" "}
                  <strong className="tt-highlight">A</strong>ccessories
                </h4>
                <span>$250</span>
              </div>
            </a>
